...
UE.I18N['en'] = {
    ...
    'autoupload': {
        ...
        'errorLoadConfig': 'Server com.mrkj.ygl.config not loaded, upload can not work.',
    },
    'simpleupload':{
        'exceedSizeError': 'File Size Exceed',
        'exceedTypeError': 'File Type Not Allow',
    ...
    'loadconfigError': 'Get server com.mrkj.ygl.config error.',
    'loadconfigFormatError': 'Server com.mrkj.ygl.config format error.',
    'loadconfigHttpError': 'Get server com.mrkj.ygl.config http error.',
    'snapScreen_plugin':{
        'browserMsg':"Only IE supported!",
        'callBackErrorMsg':"The callback data is wrong,please check the com.mrkj.ygl.config!",
    ...
    'webapp':{
        ...
        'tip2':"And then open the file ueditor.com.mrkj.ygl.config.js to set it! ",
        'applyFor':"APPLY FOR",
        'anthorApi':"Baidu API"
    },
    'template':{
