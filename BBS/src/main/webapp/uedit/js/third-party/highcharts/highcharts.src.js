...
SVGRenderer.prototype = {
	 ...
	 *
	 * @param {Object} color The color or com.mrkj.ygl.config object
	 */
	color: function (color, elem, prop) {
		...
		if (gradName) {
			...
			// Check if a gradient object with the same com.mrkj.ygl.config object is created within this renderer
			if (gradients[key]) {
				id = gradients[key].id;
...
Axis.prototype = {
	...
	/** 
	 * The default label formatter. The context is a special com.mrkj.ygl.config object for the label.
	 */
...
Chart.prototype = {
	 ...
	 *
	 * @param {Object} options The com.mrkj.ygl.config options
	...
	/**
	 * Create the Axis instances based on the com.mrkj.ygl.config options
	 */
	getAxes: function () {
		var chart = this,
			options = this.options,
 ...
 * in various arrays.
 *
 * - First, series.options.data contains all the original com.mrkj.ygl.config options for
...
Series.prototype = {
	...
	getAttribs: function () {
		...
		while (i--) {
			...
			// a specific marker com.mrkj.ygl.config object is defined for the individual point:
			...
			// no marker com.mrkj.ygl.config object is created: copy a reference to the series-wide
